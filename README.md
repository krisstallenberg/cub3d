## Introduction
Cub3d is a C program which generates raycasted 3D looking worlds, similar to those found in the 1992 game [Wolfenstein 3D](http://users.atw.hu/wolf3d/){:target="_blank"}.
